...
@property (nonatomic, strong) NSArray *bezierAnimationTypeArray;

@end

@implementation CDMainTableViewController

- (NSArray *)bezierAnimationTypeArray {
    if (!_bezierAnimationTypeArray) {
        _bezierAnimationTypeArray = @[@"bezierBall"];
    }
    return _bezierAnimationTypeArray;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.bezierAnimationTypeArray.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [self.bezierAnimationTypeArray objectAtIndex:indexPath.row];
    return cell;
}
